...
SECRET_KEY = 'django-insecure-@f)gnzh=x+s)e!g4!+&%1(dhu^)eou$)*(&cnpf1@$j-cx-0cv'
...
# The following varaibles are additional for pluging settings (some installed plugin in INSTALED_APPLICATIONS need them)
